...
class Migration_Altera_tabela_mensagens_orientador extends CI_Migration {
	...
	public function up() {
		...
		$addConstraint = "ALTER TABLE mastermind_message ADD FOREIGN KEY (IDOFFERDISCIPLINE_FK) REFERENCES offer_discipline(id_offer_discipline) ON DELETE CASCADE ON UPDATE RESTRICT;";
		$this->db->query($addConstraint);
	}
