...
class Migration_Cria_permissao_estudante extends CI_Migration {
	...
	public function down() {
		...
		$object = array('id_group' => 8, 'group_name' => "estudante");
		$this->db->delete('group', $object);
		
		$object = array('id_group' => 8, 'id_permission' => 8);
