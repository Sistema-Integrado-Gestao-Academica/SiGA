...
class Course_model extends CI_Model {
	...
	public function getCourseStudents($courseId){
		...
		$this->db->select("users.name, users.id, users.email, course_student.enroll_date, course_student.enrollment, course_student.enroll_semester");
		$this->db->from('users');
	...
	public function deleteSecretary($id_course, $id_secretary, $id_user = FALSE){
		...
		if($id_user == FALSE){
			...
			$secretaryWasDeleted = $this->db->delete('secretary_course', array('id_course' => $id_course, 'id_user'=>$id_user));
		}
