...
abstract class WeightedPhase extends ProcessPhase{
    ...
    const GRADE_REQUIRED = "A nota de corte da fase é obrigatória.";
    
	protected $weight;
	protected $grade;

	public function __construct($phaseName, $weight, $grade = FALSE, $id = FALSE, $startDate = FALSE, $endDate = FALSE){
