...
<?php
	...
	$title = array(
		...
		"class" => "form-control",
		"required" => "required",
		"value" => $eventProduction['study_title']
	);

	$eventNatureValue = array_search($eventProduction['event_nature'], $eventNatures);
	$presentationNatureValue = array_search($eventProduction['presentation_nature'], $presentationNatures);
...
<div id="form" align="center">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			<?= form_open("update_event_presentation") ?>
				
				<div class="principal"><h2>Editar Apresentação de Trabalho</h2></div>
