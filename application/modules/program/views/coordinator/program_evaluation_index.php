			    ...
			    if($dimensionsTypes !== FALSE){
			    	...
			    	foreach($dimensionsTypes as $dimension){
			    		...
			    		// 	echo "<td>";
			    			...
			    			// echo "<td>";
			    				echo anchor(
			    					"program/coordinator/evaluationDimensionData/{$programEvaluation['id_program_evaluation']}/{$dimension['id_dimension_type']}/{$programData['id_program']}",
				...
				if($allDimensionsTypes !== FALSE){
					...
					foreach($allDimensionsTypes as $dimension){
	    				...
	    				if($dimensionIsOnProgram === FALSE){
		    				...
		    				echo anchor(
		    					"program/coordinator/addDimensionToEvaluation/{$programData['id_program']}/{$programEvaluation['id_program_evaluation']}/{$dimension['id_dimension_type']}",
...
<br>
<?php echo anchor('program/coordinator/coordinator_programs', "Voltar", "class='btn btn-danger'");?>