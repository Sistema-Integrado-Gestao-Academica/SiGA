...
/**
 * Group class(on /data_types/security) test class.
...
class Group_Test extends CI_Controller{
...
// Tests for constructor with array of permissions
    ...
    public function index(){
        ...
        $this->shouldInstantiateWithId1();
        $this->shouldInstantiateWithRandomValidId();
        $this->shouldNotInstantiateWithId0();
        $this->shouldNotInstantiateWithRandomInvalidId();
        $this->shouldNotInstantiateWithNotNumericStringId();
        $this->shouldNotInstantiateWithIdFalse();
        $this->shouldNotInstantiateWithIdNull();

        $this->shouldInstantiateWithNameSecretario();
        $this->shouldInstantiateWithNameWithBlankSpace();
        $this->shouldNotInstantiateWithNotStringName();
        $this->shouldNotInstantiateWithFALSEName();
        $this->shouldNotInstantiateWithBlankName();
        $this->shouldNotInstantiateWithNullName();

        $this->shouldInstantiateWithValidProfileRoute();
        $this->shouldNotInstantiateWithProfileRouteWithBlankSpace();
        $this->shouldNotInstantiateWithNotStringProfileRoute();
        $this->shouldNotInstantiateWithFALSEProfileRoute();
        $this->shouldNotInstantiateWithBlankProfileRoute();
        $this->shouldNotInstantiateWithNullProfileRoute();

        $this->shouldAddPermission();
        $this->shouldNotAddNullPermission();
        $this->shouldNotAddArrayPermission();
        $this->shouldNotAddNonPermissionObject();
        $this->shouldAddPermissions();
        $this->shouldReturnEmptyArray();
        $this->shouldNotAddPermissions();

        $test_report = array('unit_report' => $this->unit->report());

        $this->load->view('group_test_report', $test_report);
    }
